...
url = 'https://hiking.biji.co/index.php?q=trail&page='
...
def fetch_data(page):
    ...
    for mt in mountains:
        ...
        # img = mt.find("a",class_="w-full object-cover aspect-4/3")
...
df.to_csv("trail_list.csv",index =False, encoding="utf-8")
print('已存到 trail_list.csv')