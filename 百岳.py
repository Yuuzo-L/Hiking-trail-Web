...
url = 'https://hiking.biji.co/index.php?q=trail&type=%E7%99%BE%E5%B2%B3&filter=1&page='
...
df.to_csv("BaiYue_list.csv",index =False, encoding="utf-8")
print('已存到 BaiYue_list.csv')