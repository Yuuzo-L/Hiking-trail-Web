...
url = 'https://hiking.biji.co/index.php?q=trail&type=%E5%85%B6%E4%BB%96%E5%B1%B1%E5%B2%B3&filter=1&page='
...
df.to_csv("foothills_list.csv",index =False, encoding="utf-8")
print('已存到 foothills_list.csv')